...
int main()
{
    ...
    // Create nodeA
    UdcServer* nodeA = udcCreateServer(0x01020304, 1234, 2345, buffer.data(), buffer.size(), "test_sendrecv_ipv4_logA.txt");
    ...
    // Create nodeB
    UdcServer* nodeB = udcCreateServer(0x01020304, 1235, 2346, buffer.data(), buffer.size(), "test_sendrecv_ipv4_logB.txt");
