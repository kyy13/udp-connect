...
{
    // Create nodeA
    UdcServer* nodeA = udcCreateServer(0x01020304, 1234, 2345, "test_connect_ipv6_logA.txt");
    ...
    // Create nodeB
    UdcServer* nodeB = udcCreateServer(0x01020304, 1235, 2346, "test_connect_ipv6_logB.txt");
