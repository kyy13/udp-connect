...
void UdcPacketLogger::logReceived(const UdcAddressIPv4& address, uint16_t port, const uint8_t* data, uint32_t size)
{
    m_file << "RECV IPV4 ";
...
void UdcPacketLogger::logReceived(const UdcAddressIPv6& address, uint16_t port, const uint8_t* data, uint32_t size)
{
    m_file << "RECV IPV6 ";
